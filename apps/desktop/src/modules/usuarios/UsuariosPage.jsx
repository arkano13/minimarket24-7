...
function getInitialModules(modules) {
  ...
  return modules
    .filter((module) => preferred.includes(module.codigo))
...
export default function UsuariosPage({
  ...
  async function loadData(userIdToSelect = null) {
    ...
    try {
      ...
      const requestedUserExists = loadedUsers.some(
        (user) => user.id === userIdToSelect,
      );
  ...
  function startCreate() {
    ...
    setForm({
      ...EMPTY_FORM,
      modulos: getInitialModules(modules),
    });
  ...
  function startEdit() {
    ...
    setForm({
      ...
      contrasena: "",
      confirmarContrasena: "",
      modulos: selectedUser.modulos.map(
  ...
  function toggleModule(moduleCode) {
    ...
    setForm((current) => {
      const alreadySelected =
        current.modulos.includes(moduleCode);

      return {
        ...current,
        modulos: alreadySelected
          ? current.modulos.filter(
  ...
  async function saveUser(event) {
    ...
    try {
      ...
      if (mode === "CREATE") {
        response = await createUserRequest(token, {
          ...payload,
  ...
  function roleName(roleCode) {
    return (
      roles.find((role) => role.codigo === roleCode)
        ?.nombre ?? roleCode
    );
  }
    ...
    <section className="users-page">
      <header className="users-header">
        <div>
          ...
          <p>
            Administra quién puede entrar y qué módulos puede
            utilizar.
          </p>
        </div>
          ...
          <div className="users-list">
            {filteredUsers.map((user) => (
              ...
              >
                ...
                <span
                  className={`users-status-dot ${
                    user.activo ? "is-active" : "is-inactive"
                  }`}
                  title={
          ...
          {(mode === "CREATE" || mode === "EDIT") && (
            ...
            >
              ...
              <div className="users-form-section">
                ...
                <p>
                  Selecciona el tipo de usuario. Esto ayuda a
                  organizar sus permisos.
                </p>
                  ...
                  {roles.map((role) => (
                    <button
                      className={`users-role-option ${
                        form.rol === role.codigo
                          ? "is-selected"
                          : ""
                      }`}
                      key={role.codigo}
                      onClick={() =>
                        changeRole(role.codigo)
                      }
                      type="button"
                    >
              ...
              <div className="users-form-section">
                ...
                <p>
                  Solamente verá las opciones seleccionadas.
                  Los administradores reciben acceso completo.
                </p>
                ...
                <div className="users-module-grid">
                  {modules.map((module) => {
                    const selected =
                      ...
                      form.modulos.includes(module.codigo);

                    return (
                      <label
                        className={`users-module-option ${
            ...
            <div className="users-detail">
              ...
              <div className="users-summary-grid">
                ...
                <div className="users-summary-card">
                  ...
                  <strong>
                    {formatDate(selectedUser.ultimoAcceso)}
                  </strong>
                </div>
              </div>
              ...
              <div className="users-management">
                ...
                {selectedUser.id === currentUser?.id && (
                  <p className="users-own-account-note">
                    Tu propia cuenta no puede ser desactivada.
                  </p>
                )}
                ...
                {showPasswordForm && (
                  ...
                  >
                    <div>
                      ...
                      <p>
                        El usuario deberá utilizarla en su
