...
export function VentasPage({ token }) {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(async () => {
      ...
      try {
        const result = await searchSaleClients(
          token,
          clientSearch.trim(),
        );
    ...
    <main className="sales-page">
      ...
      {cashShift === null ? (
        <p className="cash-closed-warning">
          La caja está cerrada. Abre{" "}
          <strong>Caja y turnos</strong> antes de vender.
        </p>
      ) : null}
      ...
      <div className="sales-layout">
        <section className="sales-catalog">
          ...
          <div className="sales-catalog__heading">
            ...
            <small>
              El precio mostrado ya corresponde al turno
              actual.
            </small>
          </div>
                ...
                >
                  <div className="cart-item__top">
                    <div>
                      ...
                      <small>
                        L {formatMoney(item.precio)} cada
                        uno
                      </small>
                    </div>
